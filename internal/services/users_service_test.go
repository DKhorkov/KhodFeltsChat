...
func TestUsersService_GetUsers(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := services.NewUsersService(mockUOW, newUsersRepoFunc)

			// Act
			got, err := service.GetUsers(tt.args.ctx, tt.args.filters, tt.args.pagination)
...
func TestUsersService_GetUserByEmail(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := service.GetUserByEmail(tt.args.ctx, tt.args.email)
...
func TestUsersService_GetUserByUsername(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := service.GetUserByUsername(tt.args.ctx, tt.args.username)
...
func TestUsersService_UpdateUser(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := service.UpdateUser(tt.args.ctx, tt.args.userData)
