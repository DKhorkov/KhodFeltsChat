...
func TestChatsService_GetChatMembers(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			service := services.NewChatsService(
				mockUOW,
				newChatsRepoFunc,
				newMessagesRepoFunc,
			)
			...
			// Act
			got, err := service.GetChatMembers(tt.args.ctx, tt.args.chatID)
...
func TestChatsService_GetUserChats(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := service.GetUserChats(tt.args.ctx, tt.args.userID, tt.args.pagination)
...
func TestChatsService_CreateChat(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := service.CreateChat(tt.args.ctx, tt.args.chat)
...
func TestChatsService_PrivateChatExists(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := service.PrivateChatExists(tt.args.ctx, tt.args.members)
