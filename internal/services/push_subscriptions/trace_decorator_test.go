...
import (
	...
	"github.com/DKhorkov/kfc/internal/services/push_subscriptions"
...
func TestNewTraceDecorator(t *testing.T) {
	...
	tests := []struct {
		...
		base          interfaces.PushSubscriptionsService
	}{
		{
			...
			base: mockservices.NewMockPushSubscriptionsService(gomock.NewController(t)),
		},
		{
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			decorator := push_subscriptions.NewTraceDecorator(tt.traceProvider, tt.spanConfig, tt.base)
