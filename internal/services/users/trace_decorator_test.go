...
import (
	...
	"github.com/DKhorkov/kfc/internal/services/users"
...
func TestNewTraceDecorator(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			base: mockservices.NewMockUsersService(gomock.NewController(t)),
		},
		{
...
func TestTraceDecorator_GetUsers(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			setupMocks: func(
				...
				mockBase *mockservices.MockUsersService,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockBase := mockservices.NewMockUsersService(ctrl)
