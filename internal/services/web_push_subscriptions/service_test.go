...
import (
	...
	service "github.com/DKhorkov/kfc/internal/services/web_push_subscriptions"
...
func TestService_CreateWebPushSubscription(t *testing.T) {
	t.Parallel()

	type fields struct {
		mockUOW                            func(*mockuow.MockUnitOfWork)
		mockWebPushSubscriptionsRepository func(*mockrepositories.MockWebPushSubscriptionsRepository)
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				mockWebPushSubscriptionsRepository: func(r *mockrepositories.MockWebPushSubscriptionsRepository) {
					r.EXPECT().
		...
		},
		{
			...
			want:    nil,
			wantErr: true,
			err:     customerrors.ErrWebPushSubscriptionNotFound,
		},
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockRepo := mockrepositories.NewMockWebPushSubscriptionsRepository(ctrl)

			if tt.fields.mockUOW != nil {
				tt.fields.mockUOW(mockUOW)
			}

			if tt.fields.mockWebPushSubscriptionsRepository != nil {
				tt.fields.mockWebPushSubscriptionsRepository(mockRepo)
			}

			newRepoFunc := func(_ pg.Transaction) interfaces.WebPushSubscriptionsRepository {
				return mockRepo
			}
			...
			// Act
			got, err := s.CreateWebPushSubscription(tt.args.ctx, tt.args.subscription)
...
func TestService_GetWebPushSubscriptionsByUserID(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			got, err := s.GetWebPushSubscriptionsByUserID(tt.args.ctx, tt.args.userID)
...
func TestService_DeleteWebPushSubscription(t *testing.T) {
	t.Parallel()
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Act
			err := s.DeleteWebPushSubscription(tt.args.ctx, tt.args.id)
