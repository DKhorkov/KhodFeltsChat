...
func TestTraceDecorator_Upload(t *testing.T) {
	...
	tests := []struct {
		name          string
		path          string
		setupMocks    func(*mocktracing.MockProvider, *mockservices.MockFileStorageService, *mocktracing.MockSpan)
		expectedError error
	}{
		{
			...
			setupMocks: func(
				...
				mockBase *mockservices.MockFileStorageService,
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			mockBase := mockservices.NewMockFileStorageService(ctrl)
