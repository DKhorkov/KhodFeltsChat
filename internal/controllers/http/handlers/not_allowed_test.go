...
// TestNotAllowedHandler_Basic проверяет базовый случай.
func TestNotAllowedHandler_Basic(t *testing.T) {
	t.Parallel()
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("%s_%s", tc.method, tc.path), func(t *testing.T) {
			...
			// Вызываем обработчик
			handlers.NotAllowedHandler(rr, req)
...
// TestNotAllowedHandler_AllMethods проверяет все HTTP методы.
func TestNotAllowedHandler_AllMethods(t *testing.T) {
	t.Parallel()
...
// TestNotAllowedHandler_QueryParams проверяет обработку URL с query параметрами.
func TestNotAllowedHandler_QueryParams(t *testing.T) {
	t.Parallel()
...
// TestNotAllowedHandler_Concurrent проверяет конкурентный вызов.
func TestNotAllowedHandler_Concurrent(t *testing.T) {
	t.Parallel()
...
// TestNotAllowedHandler_Headers проверяет заголовки ответа.
func TestNotAllowedHandler_Headers(t *testing.T) {
	t.Parallel()
...
// TestNotAllowedHandler_BodyWithData проверяет обработку запросов с телом.
func TestNotAllowedHandler_BodyWithData(t *testing.T) {
	t.Parallel()
...
// TestNotAllowedHandler_TableDriven табличный тест с различными сценариями.
func TestNotAllowedHandler_TableDriven(t *testing.T) {
	t.Parallel()
