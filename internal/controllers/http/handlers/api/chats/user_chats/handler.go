...
// swagger:route GET /api/chats chats GetUserChats
//
// GetUserChats
//
...
// Handler provides chats for current user with pagination.
func Handler(u interfaces.ChatsUseCases) http.HandlerFunc {
