...
// Handler refreshes accessToken and refreshToken of current user.
func Handler(
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		cookies.Set(w, login.AccessTokenCookieName, tokens.AccessToken, cookiesConfig.AccessToken)
		cookies.Set(
			w,
			login.RefreshTokenCookieName,
			tokens.RefreshToken,
