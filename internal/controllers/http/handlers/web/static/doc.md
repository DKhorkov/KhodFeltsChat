...
├── css/
│   ├── doc.md           — документация по всем CSS-классам и селекторам
...
│   ├── chat.css         — страница чатов (список, сообщения, ввод, emoji-picker, swipe-to-close на мобильном)
...
├── js/
│   ├── doc.md           — документация по всем JS-файлам и функциям
...
│   ├── chat.js          — WebSocket-чат, отправка/получение сообщений, UI чатов, свайп-закрытие (мобильный)
