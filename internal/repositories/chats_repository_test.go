...
func TestChatsRepositoryTestSuite(t *testing.T) {
	suite.Run(t, new(ChatsRepositoryTestSuite))
}

type ChatsRepositoryTestSuite struct {
	suite.Suite
...
func (s *ChatsRepositoryTestSuite) SetupTest() {
	// Применяем миграции
	s.NoError(
		goose.Up(
			s.pool,
...
func (s *ChatsRepositoryTestSuite) TearDownSuite() {
	if s.dbConnector != nil {
		s.NoError(s.dbConnector.Close())
	}
}

func (s *ChatsRepositoryTestSuite) TestGetChatMembers_Success() {
	s.createTestUsers()
	s.createTestChats()
...
func (s *ChatsRepositoryTestSuite) TestGetChatMembers_PrivateChat() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestGetChatMembers_EmptyChat() {
...
func (s *ChatsRepositoryTestSuite) TestGetChatMembers_NonExistentChat() {
...
func (s *ChatsRepositoryTestSuite) TestGetUserChats_WithoutPagination() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestGetUserChats_WithLimit() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestGetUserChats_WithOffset() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestGetUserChats_UserWithNoChats() {
...
func (s *ChatsRepositoryTestSuite) TestGetUserChats_SortingOrder() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestCreateChat_Success() {
	s.createTestUsers()
...
func (s *ChatsRepositoryTestSuite) TestCreateChat_EmptyTitle() {
	s.createTestUsers()
...
func (s *ChatsRepositoryTestSuite) TestCreateChat_NoMembers() {
	s.createTestUsers()
...
func (s *ChatsRepositoryTestSuite) TestCreateChat_InvalidMember() {
...
func (s *ChatsRepositoryTestSuite) TestCreateChat_PrivateChat() {
	s.createTestUsers()
...
func (s *ChatsRepositoryTestSuite) TestGetChatByID_Success() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestGetChatByID_PrivateChat() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestGetChatByID_NotFound() {
...
func (s *ChatsRepositoryTestSuite) TestGetChatByID_ZeroID() {
...
func (s *ChatsRepositoryTestSuite) TestChangeChatIsReadStatus_Success() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestChangeChatIsReadStatus_NonExistentRecord() {
...
func (s *ChatsRepositoryTestSuite) TestPrivateChatExists_True() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) TestPrivateChatExists_False() {
...
func (s *ChatsRepositoryTestSuite) TestPrivateChatExists_ThreeUsers() {
...
func (s *ChatsRepositoryTestSuite) TestPrivateChatExists_SingleUser() {
...
func (s *ChatsRepositoryTestSuite) TestPrivateChatExists_EmptyList() {
...
func (s *ChatsRepositoryTestSuite) TestPrivateChatExists_DifferentOrder() {
	s.createTestUsers()
	s.createTestChats()
	s.createTestChatMembers()
...
func (s *ChatsRepositoryTestSuite) createTestUsers() {
...
func (s *ChatsRepositoryTestSuite) createTestChats() {
	// Создаем чаты
	chats := []struct {
		id          uint64
		title       string
...
func (s *ChatsRepositoryTestSuite) createTestChatMembers() {
