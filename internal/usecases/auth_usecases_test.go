...
func TestAuthUseCases_RegisterUser(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_LoginUser(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_LogoutUser(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_VerifyEmail(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_ForgetPassword(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_ChangePassword(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_SendVerifyEmailMessage(t *testing.T) {
	t.Parallel()
...
func TestAuthUseCases_SendForgetPasswordMessage(t *testing.T) {
	t.Parallel()
