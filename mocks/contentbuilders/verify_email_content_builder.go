...
//
//	mockgen -source=content_builders.go -destination=../../mocks/contentbuilders/verify_email_content_builder.go -package=mockcontentbuilders -exclude_interfaces=ForgetPasswordContentBuilder,NewMessageContentBuilder
//
...
func (m *MockVerifyEmailContentBuilder) Body(ctx context.Context, user domains.User) (string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockVerifyEmailContentBuilderMockRecorder) Body(ctx, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Body", reflect.TypeOf((*MockVerifyEmailContentBuilder)(nil).Body), ctx, user)
}
