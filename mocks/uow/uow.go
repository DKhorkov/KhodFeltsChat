...
//
//	mockgen -source=uow.go -destination=../../mocks/uow/uow.go -package=mockunitofwork -exclude_interfaces=
//

// Package mockunitofwork is a generated GoMock package.
package mockunitofwork
