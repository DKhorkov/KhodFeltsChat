...
//
//	mockgen -source=upgrader.go -destination=../../mocks/upgrader/upgrader.go -package=mockupgrader -exclude_interfaces=
//

// Package mockupgrader is a generated GoMock package.
package mockupgrader
